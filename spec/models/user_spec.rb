...
describe User, :type => :model do
  ...
  describe '#sync_from_bitbucket' do
    ...
    context 'when bitbucket client raise BitBucket::Error::NotFound' do
      before do
        ...
        allow_any_instance_of(BitBucket::Issues).to receive(:list_repo).
    ...
    context 'when bitbucket client raise BitBucket::Error::Forbidden' do
      before do
        ...
        allow_any_instance_of(BitBucket::Repos::Webhooks).to receive(:list).
    ...
    context 'when bitbucket client for create hook raise BitBucket::Error::Forbidden' do
      before do
        ...
        allow_any_instance_of(BitBucket::Repos::Webhooks).to receive(:create).
          and_raise(BitBucket::Error::Forbidden.new({}))
      end
  ...
  describe '#remove_hooks_from_bitbucket' do
    context 'without bitbucket client errors' do
      before do
    ...
    context 'when bitbucket client raise BitBucket::Error::Forbiddenn' do
      before do
        project = create :project, :is_bitbucket_repository => true, :name => 'Some name',
          :bitbucket_owner => 'owner', :bitbucket_slug => 'slug'
